...
// Explicit instantiation for GRAY, uint16_t, uint8_t
template qlm::Image<qlm::ImageFormat::GRAY, uint8_t>
qlm::ConvertBitDepth<qlm::ImageFormat::GRAY, uint16_t, uint8_t>
	(const qlm::Image<qlm::ImageFormat::GRAY, uint16_t>&);
